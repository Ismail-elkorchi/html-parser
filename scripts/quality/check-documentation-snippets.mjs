...
const REPORT_PATH = "reports/documentation-snippets.json";
...
async function main() {
  ...
  console.error(
    `Documentation snippet check failed: ${String(report.failures.length)} failure(s) across ${String(report.snippetsChecked)} snippet(s).`
  );
