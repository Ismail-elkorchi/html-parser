...
function benchmark(name, html, iterations) {
  parse(html);
  ...
  const totalBytes = html.length * iterations;
...
const benchmarks = [
  benchmark("parse-medium", MEDIUM_SAMPLE, 400),
  benchmark("parse-large", LARGE_SAMPLE, 80)
];
